...
/**
 * Ширина рейла, CSS px (handoff, «Рейл»). Публичная, потому что рейл — **непрозрачный оверлей поверх холста**:
 * ровно на эту полосу камера конструктора не должна класть геометрию (`ConstructorSkin`, `setViewportInsets`).
 * Значение дублирует класс `w-[60px]` ниже — Tailwind JIT читает только литералы в разметке.
 */
