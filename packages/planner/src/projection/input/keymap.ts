...
/**
 * Guard «фокус в поле ввода — не перехватывать» (ADR 0019 E5): инпуты длины сами обрабатывают Enter/Esc/Tab
 * (спека 07), а Ctrl+Z в поле — это undo текста, не документа. `null` (фокуса нет) — перехватываем.
 */
