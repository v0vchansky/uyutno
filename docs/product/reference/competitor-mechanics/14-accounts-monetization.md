...
| `UserExport`                                                                                                                                   | 2D/model-экспорт (тоже кредит-гейтед)            | :236          |
...
| 2D-экспорт проекта                      | basic → export2D-попап; pro → полный конфиг-экспорт (`Main.jsx:648-654`)         |
