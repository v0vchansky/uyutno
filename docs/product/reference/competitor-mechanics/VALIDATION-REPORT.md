...
- Пороги/константы (`OBJECT_Y_MIN/MAX=0/1000` @11468–11469, `TERRAIN_SIZE=50000` @38221, terrain y=-0.2 @37910, moving y=-100 @37954, `maxMoveDist=5`, snap `updateDistance(15)` @41668, Snap2D дефолт 10 @9477, `moveElement(...,20)` @43989, `dropElement(...,10)` @43890, `findFreeSpace margin=1.5` @10096) — всё CONFIRMED; `moveInFrontOfLines deltaAngle=π·0.2` @10046 — из списка рабочих порогов исключён: `moveInFrontOfLines` (10038–10092) — dead code без единого вызова, `deltaAngle` внутри не используется, рабочий угловой порог — π·0.4 @10068 (исправлено 2026-08-17 по аудиту).
